...
bool UDungeonModelHelper::LineIntersectsRect(const FIntVector& p1, const FIntVector& p2, const FRectangle& r)
{
	return LineIntersectsLine(p1, p2, FIntVector(r.X(), r.Y(), 0), FIntVector(r.X() + r.Width(), r.Y(), 0)) ||
		LineIntersectsLine(p1, p2, FIntVector(r.X() + r.Width(), r.Y(), 0), FIntVector(r.X() + r.Width(), r.Y() + r.Height(), 0)) ||
		LineIntersectsLine(p1, p2, FIntVector(r.X() + r.Width(), r.Y() + r.Height(), 0), FIntVector(r.X(), r.Y() + r.Height(), 0)) ||
		LineIntersectsLine(p1, p2, FIntVector(r.X(), r.Y() + r.Height(), 0), FIntVector(r.X(), r.Y(), 0)) ||
		(r.Contains(p1) && r.Contains(p2));
}

bool UDungeonModelHelper::LineIntersectsLine(const FIntVector& l1p1, const FIntVector& l1p2, const FIntVector& l2p1, const FIntVector& l2p2)
{
