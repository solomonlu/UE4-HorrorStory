...
#include "StylizedIsaacRoomLayoutBuilder.h"
...
FIsaacRoomLayout UStylizedIsaacRoomLayoutBuilder::GenerateLayout(FIsaacRoomPtr room, FRandomStream& random, int roomWidth, int roomHeight)
{
...
void UStylizedIsaacRoomLayoutBuilder::ConnectDoors(FIsaacRoomLayout& layout, const FIntVector& doorA, const FIntVector& doorB, int brushSize)
{
...
void UStylizedIsaacRoomLayoutBuilder::PaintTile(FIsaacRoomLayout& layout, int32 x, int32 y, int brushSize, EIsaacRoomTileType tileType)
{
...
void UStylizedIsaacRoomLayoutBuilder::SetTile(FIsaacRoomLayout& layout, int x, int y, int width, int height, EIsaacRoomTileType tileType)
{
