...
// Modified for Dungeon Architect
#pragma once
 ...
 */
class FDATransformDetails : public TSharedFromThis<FDATransformDetails>, public IDetailCustomNodeBuilder, public TNumericUnitTypeInterface<float>
{
public:
	FDATransformDetails( const TArray< TWeakObjectPtr<UObject> >& InSelectedObjects, const FSelectedActorInfo& InSelectedActorInfo, IDetailLayoutBuilder& DetailBuilder );
