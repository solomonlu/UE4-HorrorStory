...
#include "SGraphPalette_PropActions.h"
#include "Core/DungeonArchitectEditor.h"
#include "Core/Graph/EdGraphSchema_DungeonProp.h"



void SGraphPalette_PropActions::Construct(const FArguments& InArgs, TWeakPtr<FDungeonArchitectEditor> InDungeonEditor)
{
...
FReply SGraphPalette_PropActions::OnActionDragged(const TArray< TSharedPtr<FEdGraphSchemaAction> >& InActions, const FPointerEvent& MouseEvent)
{
