...
void UEdGraphNode_DungeonMarker::AllocateDefaultPins()
{
	...
	CreatePin(EGPD_Output, FDungeonDataTypes::PinType_Mesh, TEXT(""), NULL, false, false, TEXT("Out"));
}
...
void UEdGraphNode_DungeonMarker::PostEditChangeProperty(struct FPropertyChangedEvent& e)
{
	...
	if (e.Property->GetFName() == "MarkerName") {
		GetGraph()->NotifyGraphChanged();
	}
}

bool UEdGraphNode_DungeonMarker::CanEditChange(const UProperty* InProperty) const
{
