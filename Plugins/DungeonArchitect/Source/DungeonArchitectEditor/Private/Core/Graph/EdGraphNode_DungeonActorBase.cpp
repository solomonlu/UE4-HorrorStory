...
{
	UEdGraphPin* Inputs = CreatePin(EGPD_Input, FDungeonDataTypes::PinType_Mesh, TEXT(""), NULL, false, false, TEXT("In"));
	UEdGraphPin* Outputs = CreatePin(EGPD_Output, FDungeonDataTypes::PinType_Marker, TEXT(""), NULL, false, false, TEXT("Out"));
}
