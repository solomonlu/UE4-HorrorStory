...
#include "SGridDungeonEdit.h"
#include "Core/EditorMode/DungeonEdMode.h"
#include "Core/EditorMode/DungeonEdModeHandler.h"
#include "PropertyEditorModule.h"
#include "../Tools/GridDungeonEdToolFactory.h"
#include "../Tools/GridDungeonEdToolPaint.h"
#include "../Tools/GridDungeonEdToolRectangle.h"
#include "../Tools/GridDungeonEdToolBorder.h"
#include "../Tools/GridDungeonEdToolFactory.h"
...
UGridDungeonEdModeHandler* SGridDungeonEdit::GetModeHandler() {
	FEdModeDungeon* DungeonEditMode = StaticCast<FEdModeDungeon*>(GLevelEditorModeTools().GetActiveMode(FEdModeDungeon::EM_Dungeon));
